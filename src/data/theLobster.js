/** Featured drop-ship partner — Lobster International catalog (cartmangear.co).
 *  Customer storefront never links out to the vendor site.
 *  Prices sourced from Lobster International (reship) category snapshot 2026-06-27.
 *  Source: https://cartmangear.co/product-category/lobster-international/
 */
...
/**
 * Lobster International kit prices (USD) = vendor cost before Undisclosed markup.
 * KIT = 10 vials unless noted as single vial.
 */
const LOBSTER_LINES = [
  { sku: "LOB-BPC12", name: "BPC-157", mg: 12, vendorCost: 80, category: "Recovery", packVials: 10 },
  { sku: "LOB-BPCTB", name: "BPC-157 + TB-500", mg: 10, vendorCost: 150, category: "Recovery", packVials: 10, form: "Lyophilized blend · 10/10mg*10vials" },
  ...
  { sku: "LOB-GLOW70", name: "Glow", mg: 70, vendorCost: 200, category: "Recovery", packVials: 10, form: "Lyophilized blend kit · Glow 70" },
  { sku: "LOB-HCG5K", name: "HCG", mg: 5000, unit: "IU", vendorCost: 80, category: "Research", packVials: 10, form: "Lyophilized vial · 5000 IU*10vials" },
  { sku: "LOB-HGH150", name: "HGH", mg: 150, unit: "IU", vendorCost: 100, category: "Growth", packVials: 1, form: "Pharma-grade kit · 150 IU" },
  { sku: "LOB-HGH310", name: "HGH", mg: 310, unit: "IU", vendorCost: 190, category: "Growth", packVials: 1, form: "Pharma-grade kit · 310 IU" },
  ...
  { sku: "LOB-PRO62", name: "TheProLobster Plus HGH", mg: 62, unit: "IU", vendorCost: 35, category: "Growth", packVials: 1, form: "Large bottle · 62 IU single vial" },
];
...
export const THE_LOBSTER_SUBMISSIONS = LOBSTER_LINES.map((line) => ({
  ...
  form:
    line.form ||
    `Lyophilized vial · ${line.mg}mg*${line.packVials}vials`,
  purity: "≥99%",
  mg: line.mg,
  unit: line.unit || "mg",
